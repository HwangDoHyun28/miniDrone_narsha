...
## 알고리즘 설명
![is_center](https://user-images.githubusercontent.com/63354116/125572421-b3185ad1-8bd9-4616-9b18-ccbad96fb9c1.png){: width="400" height="300"}
...
> [3, 2.70, 2.25, 2, 1.80, 1.55, 1.50, 1.20, 1]m의 총 9가지 지점에 대한 장애물 구멍의 크기 데이터를 얻은 후, 추출된 구멍의 크기를 이용하여 드론과 장애물 사이의 거리를 예측할 수 있도록 다항식 곡선 피팅을 해주었다.   
